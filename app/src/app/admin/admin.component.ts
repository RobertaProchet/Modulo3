...
export class AdminComponent {
  ...
  newMovie: Movie = { id: 0, title: '', year: null , cover: '', description: '', midia: '', isFavorite: false }; // Objeto para armazenar os dados do novo filme
  ...
  onSubmit() {
    ...
    this.movieService.addMovie(this.newMovie).subscribe(() => {
      ...
      this.newMovie = { id: 0, title: '', year: null, cover: '', description: '', midia: '', isFavorite: false };
